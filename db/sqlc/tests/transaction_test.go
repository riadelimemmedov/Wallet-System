...
func TestGetTransactionStatement(t *testing.T) {
	...
	arg := db.GetTransactionStatementParams{
		FromAccountID:     sql.NullInt32{Int32: account.AccountID, Valid: true},
...
func TestDeleteAccountTransactions(t *testing.T) {
	...
	transactions, err := sqlStore.ListAccountTransactions(context.Background(), db.ListAccountTransactionsParams{
		FromAccountID: sql.NullInt32{Int32: account.AccountID, Valid: true},
		Limit:         10,
		Offset:        0,
	})
...
func TestDeleteTransactionsByDateRange(t *testing.T) {
	...
	err := sqlStore.DeleteTransactionsByDateRange(context.Background(), db.DeleteTransactionsByDateRangeParams{
		StartDate: startDate,
		EndDate:   endDate,
	})
	require.NoError(t, err)

	transactions, err := sqlStore.GetTransactionsByDateRange(context.Background(), db.GetTransactionsByDateRangeParams{
		StartDate: startDate,
		EndDate:   endDate,
	})
